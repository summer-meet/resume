...
%\setmainfont[ Path = fonts/, BoldFont = GILB, BoldItalicFont = GILBI, ItalicFont = GILI, SmallCapsFont = GILC]{GIL}
%\setmainfont[ Path = fonts/, BoldFont = timesbd, BoldItalicFont = timesbi, ItalicFont = timesi, SmallCapsFont = times]{times}
%\setmainfont[ Path = fonts/, BoldFont = MinionPro-Bold, BoldItalicFont = MinionPro-BoldIt, ItalicFont = MinionPro-It, SmallCapsFont = MinionPro-Bold]{MinionPro-Regular}
\setmainfont[ Path = fonts/, BoldFont = Optima LT B, BoldItalicFont = Optima LT BI, ItalicFont = Optima LT I, SmallCapsFont = Optima LT B]{Optima LT Roman}
