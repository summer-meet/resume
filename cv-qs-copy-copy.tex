...
\newgeometry{left=1.5cm,right=1.5cm,top=1.0cm, bottom=0.5cm}  %20140829 top 1.5-->2.5
%--------------------BEGIN DOCUMENT----------------------
\begin{document}
...
\begin{tabular}{p{7.5cm}p{3.8cm}p{4.0cm}}
%------------------Basic info-----------
 %  \textsc{Address:}
   {\small 7-034,  Mass Ave 77, Cambridge, 02139}
  %&\textsc{Phone:}
  & \large{\Telefon} {\small +1 617 763 2189}
   %\multirow{3}{*}{ \Huge Qichen \textsc{Song}} \\
  % &\textsc{email:}
   & \large{\Letter} {\small \href{mailto:qcsong@mit.edu}{\textcolor{black}{qcsong@mit.edu}}}\\
%--------------------TITLE-------------
%\par{
...
\begin{tabular}{rp{14.2cm}r}
      &  \hspace{-1em} \textbf{Massachusetts Institute of Technology (MIT)} &\emph{2015.08-present}\\
...
\textbf{Research on coupling between different phonon modes in graphene} && \emph{2014.09-2015.06} \\
...
\multicolumn{3}{c}{} \\
\textbf{Research on modulation of thermal conductivity in folded graphene} && \emph{2013.11-2015.06} \\
