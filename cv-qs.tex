...
\newgeometry{left=1.5cm,right=1.5cm,top=1.56cm, bottom=0.5cm}  %20140829 top 1.5-->2.5
%--------------------BEGIN DOCUMENT----------------------
\begin{document}
...
\begin{compactitem}
       \item Independently wrote FORTRAN code of nonequilibrium molecular dynamics (NEMD)\vspace{0.2em}
